...
namespace TravelBackend.Entities
{
    public class Users
    {
        ...
        // Add for assignments (as a volunteer)
        public ICollection<VolunteerRequestAssignment> VolunteerAssignments { get; set; }

        // Add for 1:1 volunteer profile (null if not a volunteer)
